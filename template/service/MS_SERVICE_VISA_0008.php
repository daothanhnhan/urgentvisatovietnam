<?php 
    ...
    $service_sub_1 = $action->getDetail('content_service', 'id', 21);
    $service_sub_2 = $action->getDetail('content_service', 'id', 22);
    $service_sub_3 = $action->getDetail('content_service', 'id', 23);
    ...
    function year_visa () {
        ...
        if (isset($_POST['year_visa'])) {
            ...
            // $overseas = mysqli_real_escape_string($conn_vn, $_POST['overseas']);
            // $spouse = mysqli_real_escape_string($conn_vn, $_POST['spouse']);
            // $child = mysqli_real_escape_string($conn_vn, $_POST['child']);
            $note = mysqli_real_escape_string($conn_vn, $_POST['note']);

            $overseas = isset($_POST['overseas']) ? 1 : 0;
            $spouse = isset($_POST['spouse']) ? 1 : 0;
            $child = isset($_POST['child']) ? 1 : 0;

            $sql = "INSERT INTO year_visa_book (name, phone, email, address, overseas, spouse, child, note) VALUES ('$name', '$phone', '$email', '$address', '$overseas', '$spouse', '$child', '$note')";
...
.page-service .content .btn-apply a {
	...
	<div class="row">
		<div class="col-md-8">
			...
			<div class="content">
                ...
                <div class="exemption">
                    <div class="box">
                        <h2>Get Vietnam 5-year Visa Exemption Certificate WITHIN 07 DAYS</h2>
                        <div class="box-sub">
                            <?= $service_sub_3['note_en'] ?>
                        </div>
                        <span class="nut" data-toggle="modal" data-target="#book-now-1">
                            <span><i class="fa fa-edit"></i> Get Started Now</span>
                        </span>
                    </div>
                </div>
                <div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Request for Vietnam 5-year Visa Exemption Certificate</h4>
      </div>
      <div class="modal-body">
        <p class="text-center">Complete this form – Get your <b>DETAILED QUOTE + PROCEDURE</b> <b>CONSULTATION </b>within <b>04 working hours</b></p>
        <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        	<div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" id="pwd" name="name" placeholder="Your Name" required="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="tel" class="form-control" id="pwd" name="phone" placeholder="Your Phone Number" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control" id="pwd" name="address" placeholder="Your delivery address" required="">
                    </div>
                </div>
                <div class="col-md-12">
                    <p>You are requesting Vietnam 5-year visa for:</p>
                    <div class="checkbox">
                      <label><input type="checkbox" name="overseas" value="1">Overseas Vietnamese</label>
                    </div>
                    <div class="checkbox">
                      <label><input type="checkbox" name="spouse" value="1">Spouse of Vietnamese passport holder</label>
                    </div>
                    <div class="checkbox disabled">
                      <label><input type="checkbox" name="child" value="1">Child of Vietnamese passport holder</label>
                    </div>
                </div>
                
                <div class="col-md-12">
                    <div class="form-group">
                        <textarea name="note" class="form-control" placeholder="Special notes" rows="4" required=""></textarea>
                    </div>
                </div>
            </div>
			  
			
			  <button type="submit" name="year_visa" class="btn btn-primary"><i class="fa fa-edit"></i> Start My Process</button>
