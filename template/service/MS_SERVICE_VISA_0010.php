<?php 
    ...
    $service_sub_1 = $action->getDetail('content_service', 'id', 25);
    $service_sub_2 = $action->getDetail('content_service', 'id', 26);
    ...
    function apec () {
        ...
        if (isset($_POST['apec'])) {
            ...
            $sql = "INSERT INTO apec_book (name, email, phone_1, phone_2, note) VALUES ('$name', '$email', '$phone_1', '$phone_2', '$note')";
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="content">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1">Extend My Stay Now!</button>
                <div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Get My Quote</h4>
      </div>
      <div class="modal-body">
        ...
        <form action="" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
              ...
              <button type="submit" name="apec" class="btn btn-danger">Submit</button>
