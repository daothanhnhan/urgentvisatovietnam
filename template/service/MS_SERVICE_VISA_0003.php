<?php 
    ...
    $service_sub_1 = $action->getDetail('content_service', 'id', 13);
    ...
    function work_permit () {
        ...
        if (isset($_POST['work_permit'])) {
            ...
            $sql = "INSERT INTO work_permit_book (name, type, email, phone_1, phone_2, note) VALUES ('$name', '$type', '$email', '$phone_1', '$phone_2', '$note')";
	...
	<div class="row">
		<div class="col-md-8">
			...
			<div class="content">
				...
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1" onclick="add_text('Get My Quote')">Get my Vietnam Work Permit Quote</button>
				<div>
					<?= $service_sub_2['note_en'] ?>
				</div>
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1" onclick="add_text('Advise me on Vietnam work permit')">Advise me on Vietnam work permit</button>
      ...
      <div class="modal-body">
        ...
        <form action="" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
			  ...
			  <button type="submit" name="work_permit" class="btn btn-danger">Submit</button>
