<?php 
    ...
    $service_sub_1 = $action->getDetail('content_service', 'id', 27);
		...
		<div class="col-md-8">
            ...
            <div class="police-check">
                <div class="box">
                    ...
                    <p>Request Vietnam visa extension service today to avoid any unexpected subsequences caused by visa overstaying!</p>
                    <a data-toggle="modal" data-target="#book-now-1">
