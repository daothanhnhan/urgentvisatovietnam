<?php 
    ...
    $service_sub_1 = $action->getDetail('content_service', 'id', 17);
    $service_sub_2 = $action->getDetail('content_service', 'id', 18);
                ...
                <div class="btn-apply">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <a href="" title=""><i class="fa fa-external-link"></i> Apply Tourist VOA</a>
                        </div>
                        <div class="col-md-6 text-center">
                            <a href="" title=""><i class="fa fa-external-link"></i> Apply Business VOA</a>
                        </div>
                    </div>
                </div>
                <div>
        ...
        <form action="" method="post" accept-charset="utf-8">
			...
			<div class="form-group">
		    	...
		    	<div class="row">
			    	...
			    	<div class="col-xs-7">
			    		<input type="number" class="form-control" id="email1" name="phone" placeholder="Your Phone number" required="">
			    	</div>
		    	</div>
