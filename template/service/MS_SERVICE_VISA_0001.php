<?php 
    ...
    $service_sub_1 = $action->getDetail('content_service', 'id', 3);
    $service_sub_2 = $action->getDetail('content_service', 'id', 4);
    $service_sub_3 = $action->getDetail('content_service', 'id', 5);
    $service_sub_4 = $action->getDetail('content_service', 'id', 6);
    $service_sub_5 = $action->getDetail('content_service', 'id', 7);
    $service_sub_6 = $action->getDetail('content_service', 'id', 8);
    $service_sub_7 = $action->getDetail('content_service', 'id', 9);
    $service_sub_8 = $action->getDetail('content_service', 'id', 10);
    ...
    $service_sub_7 = str_replace('<span style="background-color:#3498db">', '<span class="num">', $service_sub_7);

    $list_faq = $action->getList('faq_service', 'service_id', $row['service_id'], 'id', 'asc', '', '', '');

    function arrival_assistance () {
        global $conn_vn;
        if (isset($_POST['arrival_assistance'])) {
            ...
            $sql = "INSERT INTO arrival_assistance_book (name, num, email, phone_1, phone_2, note) VALUES ('$name', '$num', '$email', '$phone_1', '$phone_2', '$note')";
...
<ul>
<li><a href="#immigration-fast-track">Immigration Fast Track</a>
<ul>
<li><a href="#visa-stamping-fast-track">Visa Stamping Fast Track (A)</a></li>
<li><a href="#stamping-immigration-fast-track">Visa Stamping &amp; Immigration Fast Track(A+)</a></li>
<li><a href="#vip-fast-track">VIP Fast Track (A++)</a></li>
<li><a href="#arrivaexcutive">Executive Fast-track (A+++)</a></li>
<li><a href="#arrivacip">CIP Fast-track (A++++)</a></li>
<li><a href="#connecting">Connecting Fast-track (A++++)</a></li>
</ul>
</li>
<li><a href="#airport-transfer">Car pickup</a></li>
</ul>
</div>
				</div>
				<div>
				...
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1" onclick="add_text('Visa Stamping & Immigration Fast Track')">Book now</button>
				<div>
					<?= $service_sub_3['note_en'] ?>
				</div>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1" onclick="add_text('Full Fast Track')">Book now</button>
				<div>
					<?= $service_sub_4['note_en'] ?>
				</div>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1" onclick="add_text('CIP Fast-track')">Book now</button>
				<div>
					<?= $service_sub_5['note_en'] ?>
				</div>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1" onclick="add_text('Connecting Fast-track')">Book now</button>
				<div>
					<?= $service_sub_6['note_en'] ?>
				</div>
                
				<div>
					<?= $service_sub_7['note_en'] ?>
				</div>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1" onclick="add_text('Arrival Airport Transfer')">Book now</button>
				<div>
					<?= $service_sub_8['note_en'] ?>
				</div>
			</div>
      ...
      <div class="modal-body">
        ...
        <form action="" method="post" accept-charset="utf-8">
			...
			<div class="form-group">
			  ...
			  <button type="submit" name="arrival_assistance" class="btn btn-danger">Submit request</button>
