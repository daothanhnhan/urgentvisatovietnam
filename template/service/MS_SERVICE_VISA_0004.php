<?php 
    ...
    $service_sub_1 = $action->getDetail('content_service', 'id', 15);
    ...
    function temporary_residence () {
        global $conn_vn;
        if (isset($_POST['temporary_residence'])) {
            ...
            $sql = "INSERT INTO temporary_residence_book (name, email, phone_1, phone_2, note) VALUES ('$name', '$email', '$phone_1', '$phone_2', '$note')";
	...
	<div class="row">
		<div class="col-md-8">
			...
			<div class="content">
				...
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#book-now-1">Get My Vietnam Temporary Residence Card</button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Get My Vietnam Temporary Residence Card</h4>
      </div>
      <div class="modal-body">
        ...
        <form action="" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
			  ...
			  <button type="submit" name="temporary_residence" class="btn btn-danger">Submit</button>
