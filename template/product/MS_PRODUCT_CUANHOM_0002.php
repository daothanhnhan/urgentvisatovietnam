<?php 
    ...
    $msxcnlt_cat = $action_product->getProductCatLangDetail_byId(153, $lang);

    $msxcnlt = $action_product->getProductList_byMultiLevel_orderProductId(153, 'desc', 1, 6, '');//var_dump($msxcn);

?>

<div class="gb-maysanxuat_cuanhua home-procat">

    <div  class="gb-maysanxuat_cuanhom_title">

        <h2><?= $msxcnlt_cat['lang_productcat_name'] ?></h2>
