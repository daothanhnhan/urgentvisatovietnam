<?php 
    ...
    $page_say = $action->getList('say', '', '', 'day', 'desc', '', '', '');
    $list_say = '<div class="row say" style="display:flex;flex-wrap:wrap;">';
    foreach ($page_say as $item) { 
         ...
         $list_say .= '<div class="col-md-4"><div class="box">';
         $list_say .= '<div class="box-1">';
         $list_say .= '<img src="/images/'.$item['image'].'">';
         $list_say .= '<div class="info">';
         $list_say .= '<p class="name"><a href="'.$item['link'].'">'.$item['name'].'</a></p>';
         $list_say .= '<p class="star"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></p>';
         $list_say .= '<p class="date">'.$day.'</p>';
         ...
         $list_say .= '</div>';
         $list_say .= '<div class="box-2"><p>'.$item['note'].'</p></div>';
         $list_say .= '</div></div>';
     }
     $list_say .= '</div>';
     // var_dump($list_say);

     $rowLang['lang_page_content'] = str_replace('<p>[list_say]</p>', $list_say, $rowLang['lang_page_content']);
?>
<style>
.say {
    margin-bottom: 40px;
...
<div class="gb-page-gioithieu">
  <?php if ($row['page_id']==49) { ?>
    <?php include DIR_BREADCRUMBS."MS_BREADCRUMS_VISA_0003.php";?>
  <?php } else { ?>
        ...
        <div class="gb-page-gioithieu-right">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <?php if ($row['page_id']==49) { ?>
                    <?php include DIR_PAGE."MS_PAGE_HNSTUDIO_0002.php";?>
                    <?php } ?>
                </div>
                <div class="col-md-4">
