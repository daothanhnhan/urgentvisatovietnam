<?php 
    $requirement_visa = $action->getDetail('quoc_gia', 'emabassy_url', $_GET['page']);
...
<div class="gb-page-gioithieu">
    <?php include DIR_BREADCRUMBS."MS_BREADCRUMS_CUANHOM_0005.php";?>
    <div class="container">
        <div class="gb-page-gioithieu-right">
            <div class="row">
                <div class="col-md-8" style="margin-bottom: 20px;">
                    <h1><?= $requirement_visa['emabassy_title'] ?></h1>
                    <hr>
                    <?= $requirement_visa['emabassy_content'] ?>
