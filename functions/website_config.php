	...
	if (isset($urlAnalytic) && $urlAnalytic != '') {        
		switch ($urlAnalytic) {
            ...
            case 'requirement_visa':
                ...
                // var_dump($_GET['slug']);
                if (isset($_GET['slug']) && $_GET['slug'] != '') {
                    $requirement_visa = $action->getDetail('quoc_gia', 'requirement_url', $_GET['slug']);
                    // var_dump($requirement_visa['requirement_title']);
                    $title = $requirement_visa['requirement_title'];
                    $meta_des = $requirement_visa['requirement_des'];
                    $meta_key = $requirement_visa['requirement_keyword'];
                } else {
                    $title = $rowConfigLang['lang_web_name'];
                    $meta_des = $rowConfigLang['lang_web_des'];
                    $meta_key = $rowConfigLang['lang_web_keyword'];
            ...
            case 'emabassy_visa':
                ...
                // var_dump($_GET['slug']);
                if (isset($_GET['slug']) && $_GET['slug'] != '') {
                    $emabassy_visa = $action->getDetail('quoc_gia', 'emabassy_url', $_GET['slug']);
                    // var_dump($requirement_visa['requirement_title']);
                    $title = $emabassy_visa['emabassy_title'];
                    $meta_des = $emabassy_visa['emabassy_des'];
                    $meta_key = $emabassy_visa['emabassy_keyword'];
                } else {
                    $title = $rowConfigLang['lang_web_name'];
                    $meta_des = $rowConfigLang['lang_web_des'];
                    $meta_key = $rowConfigLang['lang_web_keyword'];
