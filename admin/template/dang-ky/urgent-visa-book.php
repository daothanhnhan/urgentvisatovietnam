<?php
    $rows = $acc->getList("urgent_visa_book","","","id","desc",$trang, 20, $_GET['page']);//var_dump($rows);
?>	
                ...
                <?php 
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <img src="/images/upload/<?= $row['portrait'] ?>" width="100">
                            </td>
                            <td>
                                <img src="/images/upload/<?= $row['flight'] ?>" width="100">
                            </td>
                            <td><?= $row['ngay']?></td>
