<?php 
	...
	function services_team () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO services_team (name, image, note) VALUES ('$name', '$image', '$note')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một service team.\');window.location.href="index.php?page=services-team"</script>';
			} else {
