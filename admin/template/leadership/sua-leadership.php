<?php 
	...
	function leadership ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE leadership SET name = '$name', note = '$note', position = '$position' $add WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một leadership.\');</script>';
			} else {
	...
	$info = $action->getDetail('leadership', 'id', $_GET['id']);
?>
