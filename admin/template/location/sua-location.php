<?php 
	...
	function location ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE location SET name = '$name', note = '$note' , address = '$address' WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một Location.\');</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <textarea name="address" class="txtNCP1"><?= $info['address'] ?></textarea>
