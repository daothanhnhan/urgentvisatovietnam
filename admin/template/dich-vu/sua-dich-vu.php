...
<form action="" method="post" id="updateService" enctype="multipart/form-data">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <a href="index.php?page=content-service&service_id=<?= $row['service_id'] ?>" title="" style="width: 100%;">Nội dung con</a>
            <br>
            <br>
            <br>
            <a href="index.php?page=faq-service&service_id=<?= $row['service_id'] ?>" title="" style="width: 100%;">Câu hỏi</a>
            <p class="titleRightNCP">Mô tả ngắn:</p>
            ...
            <div class="subColContent">
                ...
                <select class="sltBV" name="servicecat_id" size="10">
                    ...
                    <option value="1" <?= $row['servicecat_id']==1 ? 'selected' : '' ?> style="padding-left: 0px; padding-top: 2px; padding-bottom: 2px;">
                        Service
                    </option>
                    <option value="2" <?= $row['servicecat_id']==2 ? 'selected' : '' ?> style="padding-left: 0px; padding-top: 2px; padding-bottom: 2px;">
                        Visa Guide
                    </option>
                    <option value="3" <?= $row['servicecat_id']==3 ? 'selected' : '' ?> style="padding-left: 0px; padding-top: 2px; padding-bottom: 2px;">
                        Requirements
                    </option>
                </select>
            </div>
