        ...
        <div class="boxNodeContentPage">
            ...
            <div class="subColContent">
                ...
                <select class="sltBV" name="servicecat_id" size="10">
                    ...
                    <option value="1" style="padding-left: 0px; padding-top: 2px; padding-bottom: 2px;">
                        Service
                    </option>
                    <option value="2" style="padding-left: 0px; padding-top: 2px; padding-bottom: 2px;">
                        Visa Guide
                    </option>
                    <option value="3" style="padding-left: 0px; padding-top: 2px; padding-bottom: 2px;">
                        Requirements
                    </option>
                </select>
            </div>
