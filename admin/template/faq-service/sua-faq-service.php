<?php 
	...
	function faq_service ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE faq_service SET name_en = '$name_en', note_en = '$note_en' WHERE id = $id";
	...
	$info = $action->getDetail('faq_service', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=faq-service&service_id=<?= $info['service_id'] ?>">Quay lại</a><br /><br /></p>     
