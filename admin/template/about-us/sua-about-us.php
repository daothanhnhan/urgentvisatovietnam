<?php 
	...
	function about_us ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE about_us SET name = '$name', note = '$note' $add WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một about us.\');</script>';
			} else {
	...
	$info = $action->getDetail('about_us', 'id', $_GET['id']);
?>
