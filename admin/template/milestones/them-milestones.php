<?php 
	...
	function milestones () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO milestones (name, image, note) VALUES ('$name', '$image', '$note')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một milestones.\');window.location.href="index.php?page=milestones"</script>';
			} else {
