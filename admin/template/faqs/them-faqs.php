<?php 
	...
	function faqs () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO faqs (name_en, note_en, type) VALUES ('$name_en', '$note_en', '$type')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một faq.\');window.location.href="index.php?page=faqs"</script>';
			} else {
