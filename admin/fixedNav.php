...
?>
<div class="fixedLeft">
    <div class="contentFL" style="height: 80%;overflow-y: scroll;">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=info-email" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Info email</a>
            </li>

            <li><a href="index.php?page=paypal-key" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Paypal Key</a>
            </li>

            <li><a href="index.php?page=tao-sitemap" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tạo sitemap</a>
            </li>
            ...
            <li><a href="index.php?page=nhom-faqs" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhóm FAQS</a>
            </li>

            <li><a href="index.php?page=faqs" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>FAQS</a>
            </li>

            

            <!-- <li><a href="index.php?page=arrival-assistance-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Arrival Assistance</a>
            </li>
            <li><a href="index.php?page=departure-assistance-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Departure Assistance</a>
            </li>
            <li><a href="index.php?page=work-permit-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Work Permit</a>
            </li>
            <li><a href="index.php?page=temporary-residence-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Temporary Residence Card</a>
            </li>
            <li><a href="index.php?page=urgent-visa-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Urgent Visa</a>
            </li>
            <li><a href="index.php?page=year-visa-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>5 Years Visa</a>
            </li>
            <li><a href="index.php?page=visa-extension-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Visa Extension</a>
            </li>
            <li><a href="index.php?page=apec-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>ABTC Stay Extension</a>
            </li> -->

            <li><a href="index.php?page=quoc-gia" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Quốc gia</a>
            </li>

            <li><a href="index.php?page=say" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Khách nói</a>
            </li>

            <li><a href="index.php?page=footer-content" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Footer</a>
            </li>

            <!-- <li><a href="index.php?page=arrival-port" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Arrival port</a>
            </li>

            <li><a href="index.php?page=type-visa" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Type visa</a>
            </li>

            <li><a href="index.php?page=processing-time" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Processing time</a>
            </li> -->

            

            <!-- <li><a href="index.php?page=check-status" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Check status</a>
            </li> -->

            <li><a href="index.php?page=visa-category" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Visa category</a>
            </li>

            <li><a href="index.php?page=purpose-of-visit" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Purpose of visit</a>
            </li>
            ...
            <li><a href="index.php?page=country-prefix" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Phone country</a>
            </li>

            <li><a href="index.php?page=sua-seo-page-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SEO page book</a>
            </li>

            <li><a href="index.php?page=sua-seo-check-status" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SEO check status</a>
            </li>

            <li><a href="index.php?page=service-all&parent_id=0" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Service all</a>
            </li>

            <li><a href="index.php?page=about-us" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>About us</a>
            </li>

            <li><a href="index.php?page=our-services" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Our Services</a>
            </li>

            <li><a href="index.php?page=why" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Why apply</a>
            </li>

            <li><a href="index.php?page=milestones" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Milestones</a>
            </li>

            <li><a href="index.php?page=leadership" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Leadership</a>
            </li>

            <li><a href="index.php?page=services-team" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Services Team</a>
            </li>

            <li><a href="index.php?page=typical-client" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Typical Client</a>
            </li>

            <li><a href="index.php?page=location" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Location</a>
            </li>

            <li><a href="index.php?page=book-visa" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Book visa</a>
            </li>

            <li><a href="index.php?page=home-voa" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tourist Voa</a>
            </li>

            <li><a href="index.php?page=service-book" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Service book</a>
            </li>

            <li><a href="index.php?page=create-order" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Create Order</a>
            </li>

            <li><a href="index.php?page=file-pdf" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Upload file pdf</a>
            </li>
            ...
            <?php } ?>
            <!-- <li><a href="index.php?page=arrival-port-group" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhóm port arrival</a>
            </li> -->
