...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Success</p>
            ...
            <p class="titleRightNCP">text footer</p>
            <input type="text" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home9']?>" name="content_home9"/>

			<p class="titleRightNCP">Link facebook</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link1']?>" name="link1"/>
            <p class="titleRightNCP">Link twiter</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link2']?>" name="link2"/>

            <p class="titleRightNCP">Số whatsapp</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link3']?>" name="link3"/>
            <p class="titleRightNCP">Text whatsapp</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['link4']?>" name="link4"/>

            <p class="titleRightNCP">Mã nhúng Head</p>
            <textarea name="tab_header" id="input" class="form-control" rows="3"><?php echo $rowConfig['tab_header']?></textarea>
            <p class="titleRightNCP">Mã nhúng Body</p>
            <textarea name="tab_footer" id="input" class="form-control" rows="3"><?php echo $rowConfig['tab_footer']?></textarea>
        </div>
    </div><!--end rowNodeContentPage-->
