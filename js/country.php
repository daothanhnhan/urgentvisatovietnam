...
<script>
    // var countryPrefix = document.getElementById("countryPrefix").innerHTML;
    // alert(countryPrefix);
    var list_tag = document.getElementsByTagName("option");//alert(list_tag);
    // alert(list_tag.length);
    var prefix = '';
    var name = '';
    for (var i=0;i<list_tag.length;i++) {
        prefix = list_tag[i].value;
        name = list_tag[i].innerHTML;
        // alert(list_tag[0].innerHTML);
        // alert(name);
        break;
        const xhttp = new XMLHttpRequest();
          ...
          xhttp.open("GET", "/functions/ajax/country.php?prefix="+prefix+"&name="+name, true);
          xhttp.send();
